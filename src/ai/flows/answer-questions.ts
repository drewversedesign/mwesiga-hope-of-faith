'use server';
/**
 * @fileOverview An AI agent that answers questions about the Hope of Faith Foundation.
 *
 * - answerQuestions - A function that answers questions about the foundation.
...
const AnswerQuestionsInputSchema = z.object({
  question: z.string().describe('The question to answer about the Hope of Faith Foundation.'),
});
export type AnswerQuestionsInput = z.infer<typeof AnswerQuestionsInputSchema>;

const AnswerQuestionsOutputSchema = z.object({
  answer: z.string().describe('The answer to the question about the Hope of Faith Foundation.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI chatbot assistant for the Hope of Faith Foundation, a nonprofit organization based in Uganda.  Answer the following question about the foundation:
